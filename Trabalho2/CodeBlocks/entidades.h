    ...
    public:
        ...
        */
        Cartao* GetCartao() const {
         ...
         /*! \fn bool VerificarCartao()
            \brief Verifica se ha um cartao cadastrado para o usuário.

            \return 'false', caso não tenha ou 'true', caso tenhe.
        */
        ...
        */
        ...
        /*! \fn bool VerificarConta()
            \brief Verifica se ha uma conta cadastrada para o usuário.
...
class Acomodacao {
    ...
    public:
        ...
        */
        ...
        /*! \fn std::list<Reserva> *GetReserva()
        ...
        */
        ...
        /*! \fn void SetUsuario(Usuario* usuario)
        ...
        */
        ...
        /*! \fn void IniciarReserva()
            \brief Inicia a lista de reservas
        */
        void IniciarReserva(){
            this->reserva = new list<Reserva>; 
        }

        /*! \fn void ExcuirReserva()
            \brief Deleta a lista de reservas
        */
